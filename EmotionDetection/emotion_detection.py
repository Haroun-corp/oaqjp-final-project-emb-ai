...
def emotion_detector(text_to_analyze):
    ...
    # If the response status code is 200, extract the emotions scores from the response
    ...
    # Returning a dictionary containing emotion detection and dominant emotion results
    return {
        'anger': anger_score,
